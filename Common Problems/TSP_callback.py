...
try:
  capitals_json = json.load(open('example_data/capitals.json'))
...
if __name__ == '__main__':
    ...
    m._vars = vars  ## python support dynamic attributes
    ...
    points = list(zip(*points))  # transpose to get x and y coordinates
